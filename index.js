...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.isButton()) {
        ...
        } else if (interaction.customId === 'onay' || interaction.customId === 'red') {
            await interaction.reply({ content: interaction.customId === 'onay' ? '✅ Başvuru onaylandı.' : '❌ Başvuru reddedildi.', ephemeral: true });
        }
    }
